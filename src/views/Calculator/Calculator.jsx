        ...
        <Paper className={`ohm-card`}>
          <Grid container direction="column" spacing={2}>
            ...
            <Grid item>
              ...
              <Grid container spacing={2} alignItems="flex-end">
                <Grid item xs={12} sm={6} md={6} lg={6}>
                  <Typography variant="h6">KAGE rewards estimation</Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={6} lg={6}>
                  <Typography variant="h6" align={"right"}>{isAppLoading ? <Skeleton width="80px" /> : <>{trim(rewardsEstimation, 2)} KAGE</>}</Typography>
                </Grid>
              </Grid>
              <Grid container spacing={2} alignItems="flex-end">
                <Grid item xs={12} sm={6} md={6} lg={6}>
