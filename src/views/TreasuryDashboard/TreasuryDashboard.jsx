            ...
            <Grid container spacing={2} className="data-grid">
              ...
              <Grid item lg={4} md={4} sm={4} xs={12}>
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of scST accumulated since the beginning of staking. Basically, how much scST one would have if they staked and held a single KAGE from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
