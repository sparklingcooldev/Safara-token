...
export const CurrentIndex = () => {
  ...
  return (
    <Metric
      ...
      {...sharedProps}
      tooltip="The current index tracks the amount of sOHM accumulated since the beginning of staking. Basically, how much sOHM one would have if they staked and held a single KAGE from day 1."
    />
  );
};
...
export const GOHMPrice = () => {
  ...
  return (
    <Metric
      ...
      {...sharedProps}
      tooltip={`CSTG = CSTS * index\n\nThe price of CSTG is equal to the price of KAGE multiplied by the current index`}
    />
  );
};
